...
1. Check the full [README.md](README.md) for detailed documentation, GitHub Actions setup, and all configuration options
2. Review `config.example.json` for all available settings
3. Check `debug_html.txt` and `seen_dates.json` after running to debug selector issues
